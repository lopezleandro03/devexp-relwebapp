// Adjust for ALT deployment: target rg
...
var secondaryResourceGroupName = '${resourceGroup().name}-secondary'
...
// Adjust for ALT deployment: comment out RG creation
